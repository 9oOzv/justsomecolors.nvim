...
local theme = lush(function()
  return {
    ...
    Constant        { base, fg = c1.de(30) }, -- (preferred) any constant
    ...
    -- NeoTreeDirectoryName        { low },
    -- NeoTreeDirectoryIcon        { low },
    -- NeoTreeFileIcon             { low },
    -- NeoTreeFileName             { low },
    ...
    -- NeoTreePreview              { low },
    -- NeoTreeGitAdded             { low },
    -- NeoTreeGitDeleted           { low },
    -- NeoTreeGitModified          { low },
    -- NeoTreeGitConflict          { low },
    -- NeoTreeGitIgnored           { low },
    -- NeoTreeGitRenamed           { low },
    -- NeoTreeGitStaged            { low },
    -- NeoTreeGitUnstaged          { low },
    -- NeoTreeGitUntracked         { low },
